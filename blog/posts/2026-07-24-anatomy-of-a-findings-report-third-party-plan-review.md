...
For the procedure that produces this report — the intake call, the NDA, the 48-hour read, the walkthrough — see [what happens during a construction document audit](/construction-document-audit/), and a real anonymized example at [the findings file](/findings/).
